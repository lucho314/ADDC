                    ...
                    <div class="col-md-12">
                        <div class="col-md-6">
                            <div class="form-group row">   <!--    posible_valor planta, Descripcion-->
                                ...
                                <div class="col-md-11"> <select name="tipo_planta" id="tipo_planta" class="form-control row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-md-11"><input class="form-control row" type="text"   value="0" name="sup_mensura" id="sup_mensura" value="{{$documento->sup_mensura or ''}}"> </input></div><div class="row col-md-1"><label class="unidad">m2</label></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-md-11"><input class="row form-control" type="text"  value="0" name="sup_titulo" id="sup_titulo" value="{{$documento->sup_titulo or ''}}"> </input></div><div class="row col-md-1"><label class="unidad">m2</label></div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group row">
                                <label>Exceso:</label>
                                <div class="col-md-11"><input class="row form-control" type="text"  value="0000" name="exeso" id="exeso"  value="{{$documento->exeso or ''}}"> </input></div><div class="row col-md-1"><label class="unidad">m2</label></div>
                            </div>
                        </div>
                    </div>
                </div>
